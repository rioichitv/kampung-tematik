...
<nav class="nav-glintung">
  <div class="container nav-inner">
    <div class="brand">KAMPUNG GLINTUNG GO GREEN MALANG</div>
    ...
    <ul class="nav-links">
      ...
      <li><a href="{{ route('booking') }}">Booking Kunjungan</a></li>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const navbars = document.querySelectorAll('.nav-glintung');
