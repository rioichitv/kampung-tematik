...
<head>
  ...
  <title>Galeri Kampung 1000 Topeng</title>
...
<body class="galeri-body">
  ...
  <main class="galeri-page">
    <div class="container">
      <h2>Galeri Kampung 1000 Topeng</h2>
  ...
  <div class="galeri-modal" id="galeriModalTopeng" aria-hidden="true">
  ...
  <script>
    (function() {
      const modal = document.getElementById('galeriModalTopeng');
