...
<head>
  ...
  <title>Galeri Kampung Glintung Go-Green</title>
...
<body class="galeri-body">
  ...
  <main class="galeri-page">
    <div class="container">
      <h2>Galeri Kampung Glintung Go-Green</h2>
  ...
  <div class="galeri-modal" id="galeriModalGlintung" aria-hidden="true">
  ...
  <script>
    (function() {
      const modal = document.getElementById('galeriModalGlintung');
