...
<head>
  ...
  <title>Galeri Kampung Biru Arema</title>
...
<body class="galeri-body">
  ...
  <main class="galeri-page">
    <div class="container">
      <h2>Galeri Kampung Biru Arema</h2>
  ...
  <div class="galeri-modal" id="galeriModalBiru" aria-hidden="true">
  ...
  <script>
    (function() {
      const modal = document.getElementById('galeriModalBiru');
